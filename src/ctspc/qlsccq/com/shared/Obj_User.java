...
public class Obj_User implements Serializable{
	...
	public static final String TAG_table_user="SC_USER";
	
	public static final String TAG_username_sc="username_sc";
